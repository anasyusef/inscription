          ...
          <ol className="list-outside list-decimal space-y-3 p-4">
            <li>
              <p>
                ...
                file with a supported extension and make sure {"it's"} under 390
                kB.
              </p>
            </li>
            <li>
              <p>
                <span className="font-bold">Provide your Taproot address:</span>{" "}
            ...
            <li>
              <p>
                ...
                Select how quickly you want the inscription to be processed and
                the recommended fees can be found here:{" "}
                <Link
                  className="underline"
                  target="_blank"
            ...
            <li>
              <p>
                ...
                transaction speed, {"you'll"} need to send the payable amount to
                the assigned bitcoin address.
              </p>
            </li>
          </ol>{" "}
          <p>
